...
import { 
  ...
  Activity, Layers, Cpu, Gem, Lightning, Coins, IndianRupee
} from 'lucide-react';
...
const AIModal = ({ isOpen, onClose }) => {
  ...
  const [messages, setMessages] = useState([
    { role: 'assistant', content: 'Hello! I\'m your Kamai assistant. Ask me about tax savings, earnings optimization, or expense tracking!' }
  ]);
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/10 bg-[#080715]/80 backdrop-blur-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#1BD4CA]">Powered by Gemini AI</p>
            </div>
          </div>
                ...
                <div className="p-4 border-t border-white/10 bg-[#080715]/80 backdrop-blur-xl">
                  <div className="relative">
                    <input 
                      ...
                      placeholder="Ask about taxes, earnings, expenses..."
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#080715] text-white overflow-x-hidden">
      ...
      <section className="relative pt-40 pb-32 md:pt-56 md:pb-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-lg md:text-2xl text-white/60 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            and helps you build wealth. Made for India's 75 lakh+ delivery partners.
          </p>
      ...
      <section className="py-32 relative">
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-white/60 text-xl mb-12 max-w-3xl mx-auto">
            Join 50,000+ gig workers saving an average of ₹4,500/month with Kamai's AI-powered automation.
          </p>
      ...
      {/* Live Chat Button */}
      <button className="fixed bottom-8 left-8 w-14 h-14 bg-gradient-to-br from-[#7B6BFF] to-[#1BD4CA] rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(123,107,255,0.4)] hover:shadow-[0_0_50px_rgba(27,212,202,0.6)] hover:scale-110 transition-all z-40 group">
        ...
        <div className="fixed top-24 right-8 bg-[#080715]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-4 pr-6 shadow-2xl z-40 animate-in slide-in-from-right duration-500 max-w-sm">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-white/60 text-xs">Voice-activated expense tracking now available in beta.</p>
            </div>
